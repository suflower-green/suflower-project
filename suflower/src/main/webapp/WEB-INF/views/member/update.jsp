...
<table border="1" width="1000px" height="500px">
	...
	<tr>
		<td>이메일</td>
		<td><input  type="text" id="memberMail" name="memberMail" value="${member.memberMail}"></td>
	</tr>
	<tr>
		<td>핸드폰 번호</td>
		<td><input  type="text" id="memberPhoneNum" name="memberPhoneNum" value="${member.memberPhoneNum}"></td>
	</tr>
	<tr>
		<td>우편 번호</td>
		<td><input  type="text" name="memberAddr1" id="memberAddr1" value="${member.memberAddr1}" readonly> &nbsp;&nbsp;
		<input  type="button" value="우편번호 찾기" id="" onclick="execPostCode()"><br></td>
	</tr>
	<tr>
		<td>주소</td>
		<td><input class="form-control" type="text" name="memberAddr2" id="memberAddr2" value="${member.memberAddr2}" readonly><br></td>
	</tr>
	<tr>
		<td>상세 주소</td>
		<td><input class="form-control" type="text" name="memberAddr3" id="memberAddr3" value="${member.memberAddr3}"></td>
	</tr>
	<tr>
		<td>가입일자</td>
